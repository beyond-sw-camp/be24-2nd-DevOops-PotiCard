...
const getProjectDetail = async () => {
  const project = ref([]) // { title: '', period: '', contribution: '' }
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-10 max-w-3xl mx-auto">
            ...
            <div class="w-full h-2 bg-gray-300 dark:bg-zinc-800 rounded-full overflow-hidden">
                <div class="w-1/3 h-full bg-yellow-300 rounded-full shadow-[0_0_10px_#FACC15] transition-all duration-500"></div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-3xl shadow-xl border border-gray-100 dark:border-zinc-800 p-8 md:p-10 relative overflow-hidden">
            <div class="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-point-yellow to-orange-300"></div>
                ...
                <!-- 섹션 1: 프로젝트 공통 속성 -->
                    <div class="bg-gray-50 dark:bg-zinc-800/50 rounded-2xl p-6 border border-gray-100 dark:border-zinc-800 space-y-5">
                        ...
                        <div class="space-y-1">
                            ...
                            <textarea type="text" placeholder="예: E-commerce 모바일 앱 리디자인" class="h-13 w-full px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 focus:border-point-yellow focus:ring-1 focus:ring-point-yellow outline-none transition-all text-gray-900 dark:text-white resize-none"></textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="space-y-1">
                                ...
                                <input type="text" placeholder="2023.01 - 2023.06" class="w-full px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 focus:border-point-yellow outline-none text-gray-900 dark:text-white">
                            </div>
                            <div class="space-y-1">
                                <label class="text-xs font-bold text-gray-500 dark:text-gray-400">참여도 / 역할</label>
                                <input type="text" placeholder="기여도 100% (Solo)" class="w-full px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 focus:border-point-yellow outline-none text-gray-900 dark:text-white">
                            </div>
                        </div>
                    </div>
                ...
                <!-- 섹션 2 : 프로젝트 세부 내용 -->
                    ...
                    <div class="prj_detail bg-gray-50 dark:bg-zinc-800/50 rounded-2xl p-6 border border-gray-100 dark:border-zinc-800 space-y-5">
                        <sidebar>
                            ...
                            <a hrf="#" class="prj_select bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 p-6 border border-gray-100 dark:border-zinc-800 space-y-5">
                                1
                            </a>
                            <a hrf="#" class="prj_select bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 p-6 border border-gray-100 dark:border-zinc-800 space-y-5">
                                2
                        ...
                        <main class="prj_content">
                            ...
                            <div class="space-y-1">
                                ...
                                <textarea placeholder="본 섹션의 간단한 별명을 지어주세요" class="w-full px-4 py-3 rounded-xl bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 focus:border-point-yellow focus:ring-1 focus:ring-point-yellow outline-none transition-all text-gray-900 dark:text-white h-13 resize-none"></textarea>
                            </div>
                            <!-- 상세 설명 -->
                             
                            <div class="space-y-1">
                                <label class="text-xs font-bold text-gray-500 dark:text-gray-400">상세</label>
                                <SectionEditor class="w-full px-4 py-3 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 focus:border-point-yellow focus:ring-1 focus:ring-point-yellow outline-none transition-all text-gray-900 dark:text-white"></SectionEditor>
                            </div>
                        </main>
                    </div>
