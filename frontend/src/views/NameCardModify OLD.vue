...
<template>
  <div
    class="bg-pattern text-gray-800 dark:text-gray-100 transition-colors duration-300 flex flex-col min-h-screen"
  >
    <!-- 2. 메인 콘텐츠 -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div class="lg:col-span-5 space-y-6">
            ...
            >
              ...
              <div class="mb-8">
                <label
                  class="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase block mb-3"
                  >Accent Color</label
                >
                <div class="flex flex-wrap gap-3">
                  <button
                    data-color="text-point-yellow"
                    data-bg="bg-yellow-500"
                    data-border="border-yellow-500"
                    class="w-10 h-10 rounded-full bg-point-yellow ring-2 ring-offset-2 ring-point-yellow dark:ring-offset-zinc-900 transition-all hover:scale-110"
                  ></button>
                  <button
                    data-color="text-blue-500"
                    data-bg="bg-blue-500"
                    data-border="border-blue-500"
                    class="w-10 h-10 rounded-full bg-blue-500 ring-2 ring-offset-2 ring-transparent hover:ring-blue-500 dark:ring-offset-zinc-900 transition-all hover:scale-110"
                  ></button>
                  <button
                    data-color="text-green-500"
                    data-bg="bg-green-500"
                    data-border="border-green-500"
                    class="w-10 h-10 rounded-full bg-green-500 ring-2 ring-offset-2 ring-transparent hover:ring-green-500 dark:ring-offset-zinc-900 transition-all hover:scale-110"
                  ></button>
                  <button
                    data-color="text-purple-500"
                    data-bg="bg-purple-500"
                    data-border="border-purple-500"
                    class="w-10 h-10 rounded-full bg-purple-500 ring-2 ring-offset-2 ring-transparent hover:ring-purple-500 dark:ring-offset-zinc-900 transition-all hover:scale-110"
                  ></button>
                  <button
                    data-color="text-pink-500"
                    data-bg="bg-pink-500"
                    data-border="border-pink-500"
                    class="w-10 h-10 rounded-full bg-pink-500 ring-2 ring-offset-2 ring-transparent hover:ring-pink-500 dark:ring-offset-zinc-900 transition-all hover:scale-110"
                  ></button>
                </div>
              </div>
              ...
              <div class="mb-8">
                ...
                <div class="grid grid-cols-2 gap-3">
                  <label class="cursor-pointer group relative">
                    ...
                    >
                      <span
                        class="font-sans font-bold text-gray-700 dark:text-gray-200 block text-lg"
                        >Sans-serif</span
                      >
                  ...
                  <label class="cursor-pointer group relative">
                    ...
                    >
                      <span
                        class="font-serif font-bold text-gray-700 dark:text-gray-200 block text-lg"
                        >Serif</span
                      >
            ...
            <div class="sticky top-24">
              <div class="flex justify-between items-center mb-4">
                ...
                <div class="bg-gray-100 dark:bg-zinc-800 p-1 rounded-lg flex text-xs font-bold">
                  <button
                    id="btn-front"
                    class="px-4 py-1.5 rounded-md bg-gray-800 text-white shadow-sm transition-all"
                  >
                    앞면 (Profile)
                  </button>
                  <button
              ...
              >
                ...
                >
                  ...
                  <div
                    id="card-front"
                    class="absolute inset-0 p-8 md:p-10 flex flex-col justify-between h-full"
                  >
                    <div class="flex justify-between items-start z-10">
                      <div>
                        <p
                          class="text-xs font-bold text-point-yellow uppercase tracking-widest mb-1"
                        >
                          UX/UI Designer
                        </p>
                        <h2
                          class="text-3xl md:text-4xl font-black text-gray-900 dark:text-white tracking-tight mb-2"
                        >
                          Kim Poti
                        </h2>
                    ...
                    <div class="space-y-4 z-10">
                      <div class="flex gap-2 flex-wrap">
                        <span
                          class="preview-badge px-3 py-1 bg-yellow-50 dark:bg-yellow-900/20 text-point-yellow text-xs font-bold rounded-lg border border-yellow-100 dark:border-yellow-900/30"
                          >#Figma</span
                        >
                        <span
                          class="preview-badge px-3 py-1 bg-yellow-50 dark:bg-yellow-900/20 text-point-yellow text-xs font-bold rounded-lg border border-yellow-100 dark:border-yellow-900/30"
                      ...
                      <div
                        class="pt-4 border-t border-gray-100 dark:border-zinc-800 flex justify-between items-end"
                      >
                  ...
                  >
                    ...
                    <div class="flex-1 space-y-4 overflow-y-auto pr-2 scrollbar-hide">
                      ...
                      >
                        <div
                          class="w-12 h-12 bg-gray-200 dark:bg-zinc-700 rounded-lg flex-shrink-0"
                        ></div>
                        <div>
                    ...
                    <div
                      class="mt-4 pt-4 border-t border-gray-200 dark:border-zinc-700 text-center"
                    >
