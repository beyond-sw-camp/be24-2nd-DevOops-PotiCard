    ...
    <div class="flex pt-16 min-h-screen">
      ...
      <main class="flex-1 lg:ml-64 p-8 h-screen overflow-y-auto bg-gray-50">
        <div class="grid grid-cols-[repeat(auto-fill,minmax(300px,1fr))] gap-6 pb-10">
          ...
          >
            <div
              class="relative w-80 h-52 bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col justify-between p-5 overflow-hidden transition-all duration-300 ease-out cursor-pointer hover:shadow-2xl hover:border-yellow-300 hover:scale-105 hover:-translate-y-1 z-0 hover:z-10"
            >
              <div
              ...
              <div class="flex justify-between items-end mt-4">
                <div
                  class="w-10 h-10 rounded-full border-2 border-white shadow-sm overflow-hidden group-hover:border-yellow-400 transition-colors"
                >
          ...
          <Transition name="modal-fade">
            ...
            >
              ...
              <div class="scene w-full max-w-md aspect-[1.58/1]">
                ...
                >
                  <div
                    class="card-face card-front bg-white rounded-2xl border border-gray-200 shadow-2xl p-6 sm:p-8 flex flex-col justify-between"
                  >
                    <div
                      class="absolute top-0 right-0 w-24 h-24 bg-yellow-100 rounded-bl-full z-0"
                    ></div>
                    <div class="relative z-10">
                      <p class="text-xs font-bold text-yellow-600 uppercase mb-2">
                        {{ selectedCard.role }}
                      </p>
                    ...
                    <div class="flex justify-between items-end relative z-10">
                      <img
                        ...
                        class="w-16 h-16 rounded-full border-4 border-white shadow-sm bg-gray-50"
                      />
