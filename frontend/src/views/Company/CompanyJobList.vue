          ...
          >
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
              <div class="flex-1">
                ...
                <h3
                  class="text-xl font-bold group-hover:text-indigo-600 transition-colors line-clamp-1 mb-2"
                >
                  {{ job.title }}
                </h3>
                <div class="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-zinc-500">
                  ...
                  <span class="flex items-center gap-1.5"
                    >⏳ 마감일:
                    <span
                      :class="job.status === 'RECRUITING' ? 'text-indigo-600 font-semibold' : ''"
                      >{{ job.deadline }}</span
                    ></span
                  >
                  <span class="flex items-center gap-1.5"
                    >👤 고용형태: {{ job.employmentType }}</span
                  >
                </div>
              </div>
