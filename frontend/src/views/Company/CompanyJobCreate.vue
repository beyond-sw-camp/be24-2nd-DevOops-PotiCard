        ...
        <div class="lg:col-span-8 space-y-8">
          ...
          >
            <div class="flex items-center gap-2 mb-8">
              <span
                class="w-8 h-8 flex items-center justify-center rounded-xl bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 text-sm"
                >01</span
              >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="md:col-span-2">
                <label
                  class="block text-sm font-semibold text-zinc-600 dark:text-zinc-400 mb-2 ml-1"
                  >공고 제목</label
                >
                <input
                  v-model="form.title"
                  type="text"
                  placeholder="예) 시니어 자바스크립트 개발자 채용"
              ...
              <div>
                ...
                <div class="relative">
                  <input
                    ...
                    class="w-full px-5 py-3.5 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 outline-none"
                  />
                  <span class="absolute right-4 top-1/2 -translate-y-1/2 text-sm text-zinc-400"
                    >명</span
                  >
                </div>
              </div>
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="지원자들이 맡게 될 업무를 자세히 적어주세요."
                ></textarea>
              </div>
            </div>
          </section>
          ...
          >
            ...
            <div class="mt-8 pt-8 border-t border-zinc-100 dark:border-zinc-800">
              <div
                class="flex items-center justify-between p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950"
              >
                <div class="flex items-center gap-3">
                  <input
                    id="public"
            ...
            >
              ...
              <div class="p-8">
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                  <span
                    class="px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-800 text-[11px] font-semibold"
                  >
                ...
                <div class="mt-8 flex flex-wrap gap-1.5">
                  <span
                    v-for="s in skillList.length ? skillList : ['Skill']"
                    :key="s"
                    class="text-[10px] font-bold text-zinc-500 dark:text-zinc-400"
                    >#{{ s }}</span
                  >
                </div>
              </div>
              ...
              <div
                class="px-8 py-6 bg-zinc-50 dark:bg-zinc-800/50 flex items-center justify-between"
              >
