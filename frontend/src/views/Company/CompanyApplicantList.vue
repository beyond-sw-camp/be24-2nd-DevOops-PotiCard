...
<template>
  ...
  >
    <main class="max-w-7xl mx-auto px-6 py-10">
      ...
      >
        <div
          class="px-8 pt-8 flex items-center gap-6 border-b border-zinc-50 dark:border-zinc-800 overflow-x-auto"
        >
          <button
            v-for="f in [
              { id: 'ALL', n: '전체' },
                ...
                <div class="relative">
                  ...
                  >
                    <svg
                      ...
                      class="w-3.5 h-3.5"
                      :class="
                        applicant.isFavorite ? 'fill-amber-400 text-amber-400' : 'text-zinc-300'
                      "
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
          ...
          >
            ...
            <div class="flex flex-col justify-between h-full relative z-10 text-left">
              <div class="flex justify-between items-start">
                ...
                <div
                  class="w-16 h-16 rounded-full border-4 border-white shadow-md overflow-hidden bg-gray-100"
                >
              ...
              <div class="space-y-4">
                <div class="flex gap-2">
                  <span
                    v-for="tag in selectedApplicant?.tags"
                    :key="tag"
                    class="px-2.5 py-1 bg-gray-100 text-gray-600 text-[10px] font-bold rounded-md"
                    >#{{ tag }}</span
                  >
                </div>
