    ...
    >
      ...
      <div class="p-8 md:p-10">
        <div class="text-center mb-8">
          ...
          <p
            v-if="route.query.type === 'business'"
            class="mt-5 text-gray-500 dark:text-gray-400 text-sm"
          >
          ...
          <div class="space-y-2">
            ...
            <div class="relative">
              ...
              <div v-if="checkingEmail" class="absolute right-3 top-1/2 -translate-y-1/2">
                <div
                  class="w-5 h-5 border-2 border-point-yellow border-t-transparent rounded-full animate-spin"
                >
                  ✓
                </div>
              </div>
            ...
            <div v-if="joinForm.password" class="mt-2">
              <div class="w-full h-2 rounded-full bg-slate-200 dark:bg-zinc-700 overflow-hidden">
                <div
                  ...
                  :class="[passwordStrength.bg, strengthWidthClass]"
                ></div>
              </div>
