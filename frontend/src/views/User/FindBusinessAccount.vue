  ...
  >
    ...
    >
      ...
      <div class="pt-12 pb-10 px-8 text-center">
        <h2
          class="text-4xl font-bold dark:text-[#facc15] text-black mb-3 tracking-tight font-poppins"
        >
          Find Account
        </h2>
      ...
      <div class="p-8 md:p-10">
        ...
        <div v-if="activeTab === 'findId'">
          ...
          <div v-else-if="findResult === 'id_success'" class="text-center space-y-6 py-4">
            ...
            <div>
              ...
              <h3
                class="text-2xl font-bold text-center tracking-tight text-slate-900 dark:text-white font-poppins"
              >
                poti****@company.com
              </h3>
            </div>
        ...
        <div v-if="activeTab === 'resetPw'">
          ...
          <div v-else-if="findResult === 'pw_success'" class="text-center space-y-6 py-4">
            ...
            <div>
              ...
              <p
                class="text-slate-500 dark:text-zinc-400 text-sm mb-1 text-center font-medium leading-relaxed"
              >
        ...
        >
          <RouterLink to="/login?type=business" class="hover:text-primary transition-colors py-1"
            >로그인으로 돌아가기</RouterLink
          >
          <div class="w-px h-3 bg-slate-200 dark:bg-zinc-800"></div>
          <RouterLink
            to="/signup-business"
            class="hover:text-primary transition-colors font-bold text-slate-600 dark:text-zinc-300 py-1"
            >기업 회원가입</RouterLink
          >
        </div>
      </div>
