  ...
  >
    ...
    >
        ...
        <div class="flex border-b border-slate-100 dark:border-zinc-800/50 relative">
          ...
          >
            ...
            <div
              ...
              class="absolute bottom-0 left-0 w-full h-0.5 bg-[#facc15] transition-all duration-300"
            ></div>
          </button>
          <button
      ...
      <div class="p-8 md:p-10">
        ...
        >
          <RouterLink to="/login?type=personal" class="hover:text-[#facc15] transition-colors py-1"
          ...
          <RouterLink
            ...
            class="hover:text-[#facc15] transition-colors font-bold text-slate-600 dark:text-zinc-300 py-1"
            >회원가입</RouterLink
          >
        </div>
      </div>
